                ...
                @else
                    ...
                    @if ($moduloActual)
                        @php
                            ...
                            $haPerdido = false;
                            if ($moduloActual->ganador_id && $moduloActual->ganador_id !== $usuarioActualId) {
                                $haPerdido = true;
                            }
                        @endphp
                        ...
                        @if ($haPerdido)
                            <div class="mt-4 p-4 bg-red-100 text-red-700 rounded shadow">
                                <h2 class="text-xl font-bold mb-2">Has sido eliminado del torneo</h2>
                                <p>¡Gracias por participar y suerte la próxima vez!</p>
                            </div>
                        @else
                            @php
                            ...
                            @if ($equipoContrincante)
                                <div class="bg-gray-100 p-4 rounded-lg shadow mt-4">
                                    ...
                                    <div class="grid grid-cols-3 gap-4">
                                        @foreach([
                                            $equipoContrincante->pokemon1, 
                                            $equipoContrincante->pokemon2, 
                                            $equipoContrincante->pokemon3, 
                                            $equipoContrincante->pokemon4, 
                                            $equipoContrincante->pokemon5, 
                                            $equipoContrincante->pokemon6
                                        ] as $pokemon)
